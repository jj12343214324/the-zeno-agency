    ...
    <section className="relative h-[600px] overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center z-10">
        <div className="w-full max-w-7xl mx-auto px-4">
          <div className="max-w-lg bg-white p-10 shadow-xl">
            <h1 className="text-2xl md:text-3xl font-bold text-[#0F3E54] mb-3 leading-tight">
              We don&apos;t make a living selling policies...
            </h1>
            <h2 className="text-2xl md:text-3xl font-bold text-[#0F3E54] mb-5 leading-tight">
            ...
            <Link
              href="/contact"
              className="inline-block bg-[#0F3E54] text-white px-8 py-4 font-semibold uppercase tracking-wider hover:bg-[#00224F] transition-colors text-sm"
            >
              Connect
            </Link>
          </div>
